...
0x2531   0x00     RW      U32       零位设置 (1=机械零位)
0x2531   0x02     RW      U32       力矩传感器零漂标定 (V1.2 新增)
...
| 版本 | 日期 | 变更说明 |
|------|------|----------|
| V2.1 | 2026-08-02 | 新增 0x2531 sub=0x02 力矩传感器零漂标定 OD 条目；版本号更新 |
| V2.0 | 2026-08-01 | 初版 (基于 V1.2 透传协议 + V1.1 字典表) |
