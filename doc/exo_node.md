...
| `report [period_ms]` | 0=停止 | 定时数据上报 (等效 GD32 的 CA 通道) |
...
| 维度 | GD32 MCU 方案 | RV1126B + motor_hal_c 新方案 |
|------|--------------|---------------------------|
| 主控 | GD32F503V (Cortex-M4) | RV1126B (Cortex-A7 + Linux) |
| CAN | CAN 1Mbps | CANFD 5Mbps (数据段) |
| 控制接口 | UART 串口 `@..@/` 协议 | C API + POSIX SHM |
